...
class ResponsiveSize {
  ...
  ResponsiveSize(
    this.context, {
    double? fontScale,
  }) : _manualScale = fontScale ?? 1.0;

  // ------------------- Font scaling -------------------
  double get fontScale {
    final systemScale = MediaQuery.textScalerOf(context).scale(1);
    return (systemScale * _manualScale).clamp(0.8, 1.5);
  }
  ...
  double get cardAspectRatio =>
      pick(mobile: 1.2, tablet: 1.1, desktop: 1.0);

  // ------------------- Panels / Sidebars -------------------
  double get panelPadding => padding;
  ...
  // ------------------- Layout / Spacing -------------------
  double get defaultPadding => padding;
  double get rowSpacing => padding;
  double get columnSpacing => padding;
  ...
  // ------------------- EdgeInsets helpers -------------------
  EdgeInsets get edgeInsets => EdgeInsets.all(defaultPadding);
